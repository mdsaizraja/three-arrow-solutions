...
const GitHubSection = () => {
  return (
    <div className="xl:flex xl:mt-52 mt-20">
      <div className="xl:w-7/12 xl:pr-24 pl-9">
        <HeadingTitle>Ut id tincidunt libero, ac luctus libero.</HeadingTitle>
        <h2 className="font-black xl:text-8xl text-6xl leading-loose underline text-[#ff8a71]">
          Dribble Github
        </h2>
      </div>
      <div className="flex flex-col">
        <div className="xl:flex m-10  justify-between">
