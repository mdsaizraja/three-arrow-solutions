...
const Header = () => {
    ...
    return (
        <>
            <div
                className={`h-full w-full ${navWidth} fixed z-10 top-0 left-0 xl:overflow-hidden overflow-x-scroll CloseNav`}
            >
                <div
                    className='dark:bg-black bg-white h-full'
                    ref={navBar}
                >
                    <div className="xl:mx-16 xl:py-8 py-5 mx-5">
                        ...
                        <div className='mt-20'>
                            <div
                                ...
                                className="flex md:flex-row flex-col mt-7 py-10 xl:px-10 px-10 justify-between rounded-xl xl:items-center mb-20 Carrer_div"
                            >
                    ...
                    <span className="flex w-[20%] items-center  font-bold">
                      <FiPhoneCall/> <span className="ml-2">Call</span>
                            ...
                            <div className="flex xl:flex-row flex-col xl:items-center justify-between mt-5">
                                ...
                                <div
                                    className="xl:w-[65%] xl:mx-0 mx-5 grid xl:mt-5 mt-20 md:grid-cols-3  gap-8 dark:text-white text-black text-lg ">
                    ...
                    before:h-5"
                                        ...
                                        <div className='mt-16'>
                                            ...
                                            <ol className='text-2xl mt-10'>
                                                <li
                                                    className="relative mb-5 cursor-pointer  px-16 before:ml-8 before:absolute before:-left-4 before:bottom-1
                    before:border-2 hover:before:bg-[#E99080] before:top-0 before:border-[#E99080] before:border-solid before:rounded-full before:contents:(' ') before:w-5
                    before:h-5"
                                                >
                                                    Home
                                                </li>
