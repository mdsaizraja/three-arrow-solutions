...
const Header = () => {
    ...
    const renderThemeChanger = () => {
        ...
        if (currentTheme === "dark") {
            return (
                <GiStripedSun onClick={() => setTheme('light')}/>
            )
        } else {
            return (
                <img src='/images/dark_mode.png' alt='dark_mode.png' width='25px' onClick={() => setTheme('dark')}/>
            )
        }
    };
