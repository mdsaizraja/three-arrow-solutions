...
const Footer = () => {
    return (
        <div
            className="xl:mt-52 mt-20 bg-[#031B34] sm:overflow-hidden md:px-10 xl:px-0 px-0 text-white"
        >
            <div className="container mx-auto">
                ...
                <div className="xl:px-96 xl:py-10 px-5">
                    <HeadingSection
                        className=" font-extrabold xl:text-7xl text-6xl xl:text-center text-left leading-tight tracking-wide py-3 Footer_head">
                        We are just few steps away to help you grow in this digital world.
                    </HeadingSection>
                </div>
                <div className="flex justify-center">
                    <button
                        className="border-2 px-20 py-6 transition-all delay-100 duration-700  rounded-full  hover:text-black hover:bg-white">
                        Let's discuss
                    </button>
                </div>
                <div>
