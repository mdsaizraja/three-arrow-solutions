        ...
        return (
          <div>
            ...
            <div className={`absolute z-[999] w-full flex  justify-center `}>
              <div
                className={`relative xl:left-[10%] xl:top-[-120px] md:top-[-80px] md:left-[17%] top-[-40px] left-[65px]  md:w-20 md:h-20 w-10 h-5 bg-black md:p-10 p-5 rounded-full shadow-xl`}
              >
                {" "}
              ...
              <img
                ...
                alt="image"
                className="xl:w-96 xl:h-96 md:w-[210px] md:h-[150px] w-[100px] h-[80px]  relative z-[-1] xl:top-[-100px] md:top-[-70px] top-[-35px]"
              />
            </div>
          </div>
        );
